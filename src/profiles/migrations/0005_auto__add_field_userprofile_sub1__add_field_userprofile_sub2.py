...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.sub1'
        db.add_column('profiles_userprofile', 'sub1',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.sub2'
        db.add_column('profiles_userprofile', 'sub2',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.sub1'
        db.delete_column('profiles_userprofile', 'sub1')

        # Deleting field 'UserProfile.sub2'
        db.delete_column('profiles_userprofile', 'sub2')
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sub1': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'sub2': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
