...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_userprofile', 'avatar', self.gf('django.db.models.fields.files.ImageField')(null=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'UserProfile.avatar'
        db.alter_column('profiles_userprofile', 'avatar', self.gf('django.db.models.fields.files.FileField')(null=True, max_length=100))
