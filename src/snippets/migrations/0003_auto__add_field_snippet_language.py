...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('snippets_snippet', 'language',
                      self.gf('django.db.models.fields.CharField')(default='php', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snippet.language'
        db.delete_column('snippets_snippet', 'language')
    ...
    models = {
        ...
        'snippets.board': {
            ...
            'read_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'related_name': "'readable'", 'to': "orm['auth.User']"}),
            'write_public': ('django.db.models.fields.BooleanField', [], {}),
            'write_users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'symmetrical': 'False', 'related_name': "'writeable'", 'to': "orm['auth.User']"})
        },
        'snippets.snippet': {
